...
AddEventHandler('QBCore:Client:OnPlayerLoaded', function()
    ...
    QBCore.Functions.TriggerCallback('A7md-scoreboard:server:GetConfig', function(config)
...
--                 QBCore.Functions.TriggerCallback('A7md-scoreboard:server:GetPlayersArrays', function(playerList)
--                     QBCore.Functions.TriggerCallback('A7md-scoreboard:server:GetActivity', function(cops, ambulance, rests)
...
-- 			       --QBCore.Functions.TriggerCallback('A7md-admins:server:GetPermissions', function(dfxxdfd)
-- 			       --Config.IllegalActions = config
...
Citizen.CreateThread(function()
    ...
    exports["A7md-keybinds"]:registerKeyMapping("", "Scoreboard", "Open", "+homebutton", "-homebutton", "HOME")
...
RegisterNetEvent('A7md-scoreboard:client:SetActivityBusy')
AddEventHandler('A7md-scoreboard:client:SetActivityBusy', function(activity, busy)
